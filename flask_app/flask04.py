...
from flask import render_template, Flask, request, redirect, url_for  # Flask is the web app that we will customize
...
@app.route('/index')
def index():
    a_user = {'name': 'Christina', 'email': 'mogli@uncc.edu'}
